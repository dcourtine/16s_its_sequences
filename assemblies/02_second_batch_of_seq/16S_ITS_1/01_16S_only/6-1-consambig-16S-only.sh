...
do
      perl 6-2-keep-primer-16S-only.pl $file $file.keepprimer >temp.txt
      ...
      echo "$nom_seq"
      rm temp.txt
      perl 6-3-clear_consambig-16S-only.pl $file.keepprimer.consambig $file.keepprimer.consambig.fasta $file.keepprimer.consambig.err
done
